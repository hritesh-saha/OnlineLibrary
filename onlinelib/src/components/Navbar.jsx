...
export default function Navbar(data) {
  ...
  const [nameList,setNameList]=useState([])
    ...
    <div style={{backgroundColor:"beige",border:"solid"}}>
        ...
        <ul style={{listStyle:"none",paddingLeft:"7rem",paddingRight:"7rem",paddingTop:"1.5rem",paddingBottom:"1.5rem",display:"flex",justifyContent:"flex-end",marginRight:"2.75rem",marginLeft:"600px",alignItems:"center"}} className="px-28 py-4 flex space-x-11 justify-end">
